...
class Association(threading.Thread):
    ...
    def accepted_contexts(self) -> list[PresentationContext]:
        #print("AcceptedPresentationContextsFromAssocClass",sorted(self._accepted_cx.values(), key=lambda x: cast(int, x.context_id)))
    ...
    def _get_valid_context(
        ...
        """
        #print("ab_syntax",ab_syntax)
        #print("tr_syntax",tr_syntax)
        ...
        #for cx1 in possible_contexts:
           # print("cx1",cx1.transfer_syntax)
        # Filter by abstract syntax
        possible_contexts = [
            cx for cx in possible_contexts if ab_syntax == cx.abstract_syntax
        ]
        print("PossibleContextsFromAssociation",ab_syntax,",,,,,,,", tr_syntax)
        ...
        #print("roleFromAssocClass",role)    
        #possible_contexts[0].transfer_syntax=["1.2.840.10008.1.2.4.70"]
        #print("possible_contextsFromAssocClass",possible_contexts[0].transfer_syntax)
        #possible_contexts.append("1.2.840.10008.5.1.4.1.1.7")
        ...
        role = role or "scu"
        #print("MatchesFromAssocClass",matches)
        msg = (
    ...
    def _serve_request(self, msg: DimseServiceType, context_id: int) -> None:
        ...
        #print("context_idAssocClass",context_id)
        try:
